...
while True:
    ...
    if ans!="no" and len(ans)==2 and typearg == 'sit_up':
        ans[0]=round(ans[0])
        ans[1]=round(ans[1])
           
        if prev_ang!=-1 and ans[1]>=60 and ans[1]<=120:
            if ans[0]==prev_ang:
                ...
                direction='up'
                if prev_ang<170:
                    print('you are not lowering your body fully down')
                    put_text(image,'INCORRECT: you are not lowering your body fully to the ground)',0,0,255)
            else:
                put_text(image,'GOING CORRECT: ',0,255,0)
        ...
        elif prev_ang==-1 and ans[1]>=60 and ans[1]<=120:
             prev_ang = ans[0]    
            
        else:
             print('adjust your knee angle ')
             put_text(image,'INCORRECT: adjust your knee angle to 90 degree',0,0,255)
