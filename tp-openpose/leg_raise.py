...
while True:
    ...
    if typearg=='push_ups' or typearg=='high_plank' or typearg=='leg_raise':
    ...
    if ans!="no" and len(ans)==2 and typearg == 'leg_raise':
        ans[0]=round(ans[0])
        ans[1]=round(ans[1])
        if prev_ang!=-1 and ans[1]>=170 :
            if ans[0]==prev_ang:
                ...
                direction='up'
                if prev_ang>175:
                    print('you are not lowering your lower part of the body to the ground')
                    put_text(image,'INCORRECT: you are not lowering your lower part of the body to the ground',0,0,255)
                ...
                direction='down'
                if prev_ang<115:
                	print('you are not properly raising your lower body to 90 degree')
                	put_text(image,'INCORRECT: you are not properly raising your lower body to 90 degree',0,0,255)
            else:
            	put_text(image,'GOING CORRECT: ',0,255,0)
